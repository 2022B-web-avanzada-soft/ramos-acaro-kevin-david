...
var Computador = /** @class */ (function () {
    function Computador(nombre, marca, serial, precio, componentes) {
        this.nombre = nombre;
        this.marca = marca;
        this.serial = serial;
        this.precio = precio;
    ...
    Computador.obtenerComputadores = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, (0, archivos_1.leerArchivo)("./ListaDeComputadores.txt")];
                    case 1:
    ...
    Computador.prototype.agregarComponente = function (componente) {
        this.componentes.push(componente);
    };
    Computador.prototype.eliminarComponente = function (componente) {
